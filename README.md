...
Het logboek moet laten zien:
• Hoe je activiteiten koppelt aan leerresultaten.  
• Hoe je feedback hebt ontvangen, vastgelegd en verwerkt (verbeteringen, beslissingen, aanpassingen).  
• Hoe je reflecteert op je voortgang met behulp van de STARRT-methode (intake- en voortgangsgesprekken).  
• Welke conclusies en inzichten dit oplevert voor je professionele groei.  
-->
...
- [STARRT - Voortgang](#starrt---voortgang)
- [Conclusies & Inzichten](#conclusies--inzichten)

---
# Zelfevaluatie
In het intake gesprek, werd per criterium gevraagd aan te geven op welk niveau ik zelf dacht te zitten. Hieruit volgde:

## A. Contextualiseren en Ontwerpen
Je ontwerpt AI-oplossingen en handelt daarbij vanuit expliciet gemaakte ethische normen en waarden.  
Voor deze ontwerpen werk je intensief samen met belanghebbenden en collega’s.

| Leeruitkomst | Niveau | Toelichting / Bewijs |
|---------------|---------|----------------------|
| **A1** – Onderzoeken en herformuleren van probleem en belangenafweging | Op niveau | Tijdens mijn bachelor Automotive Engineering heb ik geleerd om problemen gestructureerd in kaart te brengen en systematisch tot oplossingen te komen. |
| **A2** – Opstellen van juridische, ethische, organisatorische, functionele en technische requirements | Hier is nog werk nodig | Ik heb nog nooit een vak gevolgd waarin ethiek een rol speelde. Daarom verwacht ik dat dit criterium extra aandacht vergt. |
| **A3** – Ontwerpen en verfijnen van AI-oplossingen volgens AI-specifieke ontwerprichtlijnen (vertrouwen, veiligheid, privacy, etc.) | Op niveau | Tijdens mijn bachelor heb ik veel vooronderzoek gedaan voor ontwerpen. Door stages waarin ik front- en backends heb gebouwd, heb ik ervaring met foutafhandeling en kwaliteitsontwerp. |
| **A4** – Beoordelen in hoeverre AI geschikt is voor een vraagstuk en bepalen van de juiste mate van automatisering | Hier is nog werk nodig | Niveaus van automatisering en het ethische aspect zijn nieuw voor mij. Dit vraagt extra aandacht. |

---

## B. Ontwikkelen en Modelleren
Je ontwikkelt AI-oplossingen met diep technologisch begrip en bewustzijn van ethische waarden.

| Leeruitkomst | Niveau | Toelichting / Bewijs |
|---------------|---------|----------------------|
| **B1** – Verkennen en prepareren van datasets, inclusief onderbouwing van datakeuze | Op niveau | Tijdens de minor Data Science aan de HvA was het verkennen en voorbereiden van datasets dagelijkse praktijk. |
| **B2** – Opstellen van AI-architecturen en selecteren van passende technieken | Op niveau | In de Data Science minor heb ik geleerd AI-technieken te kiezen en toe te passen op datasets (machine learning, deep learning, computer vision). |
| **B3** – Ontwikkelen van een AI-model via een iteratief en systematisch proces | Op niveau | Gezien mijn ervaring met B1 en B2, en mijn analytische denkwijze uit mijn bachelor, verwacht ik dat dit geen probleem zal zijn. |

---

## C. Evalueren en Monitoren
Je monitort en evalueert AI-oplossingen en reflecteert op hun maatschappelijke impact.

| Leeruitkomst | Niveau | Toelichting / Bewijs |
|---------------|---------|----------------------|
| **C1** – Evalueren van maatschappelijke consequenties en in gesprek gaan met vakgenoten | Hier is nog werk nodig | Zie toelichting bij A2: het ethische aspect vraagt nog verdere ontwikkeling. |
| **C2** – Beoordelen van modelkwaliteit aan de hand van erkende criteria (robustness, performance, scalability, explainability, etc.) | Op niveau | Tijdens de Data Science minor heb ik kennis opgedaan van performance en robustness. Door mijn stage heb ik ook ervaring met scalability en resource demand. |
| **C3** – Testen met stakeholders via prototypes en integreren van inzichten in het proces | Op niveau | Tijdens mijn bachelor heb ik veel fysieke prototypes getest. In mijn stage heb ik digitale prototypes ontwikkeld (frontend lay-outs). |

---

## D. Zelfsturing
Je bepaalt zelfstandig wat nodig is om een complex AI-vraagstuk op te lossen, herkent kennislacunes en pakt deze aan.

| Leeruitkomst | Niveau | Toelichting / Bewijs |
|---------------|---------|----------------------|
| **D1** – Verzamelen, verwerken en toepassen van feedback op eigen ontwikkeling | Op niveau | Door mijn HBO-bachelor heb ik veel zelfreflectie moeten doen; dit vormt een sterke basis voor deze leeruitkomst. |
| **D2** – Zelfstandig opzetten, uitvoeren en rapporteren van onderzoek volgens vakstandaarden | Op niveau | In beide stages en diverse vakken heb ik onderzoek uitgevoerd en onderzoeksrapporten geschreven. |
| **D3** – Kiezen van robuuste onderzoeksmethoden en bijdragen aan nieuwe kennis binnen AI | Hier is nog werk nodig | Het bijdragen aan nieuwe kennis binnen specifiek het AI-vakgebied is nieuw voor mij en vereist verdere ontwikkeling. |
...
Koppel hier je uitgevoerde activiteiten aan de criteria van de master.  
...
|  | I | Requirements opgesteld voor een classificatiemodel voor M&T Datapunt 1a | DLO Assigments |  |
...
|  | I  | Voor M&T Datapunt 1a heb ik in meerdere iteraties het naar mijn mening meest geschikte model gefit.| DLO Assignments
|  | I | Voor M&T Datapunt 1b heb ik stapsgewijs het meest simpele model gefit om de ground truth te achterhalen. | DLO Assigments | 
...
# Feedback
Gebruik deze tabel doorlopend tijdens het blok om feedback te verzamelen en te tonen hoe je ermee hebt gewerkt.
...
# STARRT - Intake
Gebruik de STARRT-methode voor het intakegesprek (week 1–2).
...
# STARRT - Voortgang
Gebruik deze STARRT-reflectie voor het voortgangsgesprek (halverwege het blok).
...
Beschrijf wat je geleerd hebt, welke feedback het meest waardevol was, hoe je professioneel bent gegroeid en hoe je dit gaat toepassen in volgende blokken.

- Wat ging goed  
- Wat kon beter  
- Wat heb je geleerd  
- Hoe ga je dit meenemen naar de toekomst
